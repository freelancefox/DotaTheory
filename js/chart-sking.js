...
$(function () {
  $('#stats2').highcharts({
    ...
    series: [{
      name: 'Duration',
      data: [2.17, 0, 0, 2.5, 3.5, 5, 4, 16, 5]
    }, {
      name: 'Cooldown',
...
$(function () {
  $('#stats4').highcharts({
    ...
    series: [{
      ...
      yAxis: 1,
      name: 'Total Cost',
      data: [11960, 6940, 9720, 7420, 11700, 4700, 7260, 6940, 2720, 2240, 4700, 2300, 0]
    }, {
      yAxis: 1,
      name: 'Total Cost w/ Octarine',
      data: [17860, 12840, 15620, 13320, 17600, 13160, 12840, 10600, 8620, 8140, 10600, 8200, 5900]
    }]
  });
});
$(function () {
